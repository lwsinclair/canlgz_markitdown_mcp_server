[![MseeP.ai Security Assessment Badge](https://mseep.net/pr/mcp-mirror-canlgz-markitdown-mcp-server-badge.png)](https://mseep.ai/app/mcp-mirror-canlgz-markitdown-mcp-server)
